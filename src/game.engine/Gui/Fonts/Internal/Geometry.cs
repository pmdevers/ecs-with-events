...
namespace Game.Engine.Gui.Fonts.Internal
{
    ...
    static class Geometry {
        public static void ComposeGlyphs (int glyphIndex, int startPoint, ref Matrix2 transform, List<PointF> basePoints, List<int> baseContours, BaseGlyph[] glyphTable) {
